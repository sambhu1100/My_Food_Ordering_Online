...
<html>
            ...
            function selectAll(){
                ...
                if(result){
                    for(var i=0;i<all.length;i++){
                        document.forms["ManageEmployeeAdmin"].chbx_Delete[i].checked=true;
                    }
                }else{
                    for(var i=0;i<all.length;i++){
                        document.forms["ManageEmployeeAdmin"].chbx_Delete[i].checked=false;
                    }
                }
            }
        </script>
    ...
    <div class="container">       
        <form action="" method="post" id="ManageEmployeeAdmin">
                    ...
                    if(con!=null){
                        ...
                        while(rs.next()){
                            ...
                            <tr bgcolor="#DAF7A6">
                                ...
                                <td>
                                    <input type="checkbox" class="chbxDelete" name="chbx_Delete" value="<%=rs.getString("ename")%>">
                                </td>
                            </tr>
                            <%
                        }
            ...
            <tr>
                <td colspan="2">
                    <button type="submit" class="btn" onclick="return confirmAction()" formaction="EmployeeAddAdmin.jsp">Add New</button>
                </td>
                <td>
                    <button type="submit" class="btn" onclick="return confirmAction()">Update</button>
                </td>
                <td colspan="2">
                    <button type="submit" class="btn" onclick="return confirmAction()" formaction="">Delete</button>
                </td>
            </tr>
            <tr>
                <td colspan="4">
